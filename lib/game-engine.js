...
export function createInitialState() {
  return {
    ...
    selectedAnswers: /** @type {Record<number, string>} */ ({}),
    artifactAnswers: /** @type {Record<number, string>} */ ({}),
    artifactCorrect: 0,
    artifactAttempts: 0,
    hintsUsed: /** @type {Array<number | string>} */ ([]),
    severeFlags: /** @type {string[]} */ ([]),
    recoveredFlags: /** @type {string[]} */ ([]),
    completed: false,
  };
}
